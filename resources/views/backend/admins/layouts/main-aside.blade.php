...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="index.html"><img src="{{ asset('img/logo-ligth.png') }}" class="main-logo" alt="logo"></a>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    <i class="fe fe-user ml-2 mr-2"></i>
...
{{--                        <a class="slide-item text-capitalize" href="{{ route('instructor.index') }}">instructors</a>--}}
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    <i class="fe fe-users ml-2 mr-2"></i>
