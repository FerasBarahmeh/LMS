<x-card-simple-collapse :id="'collapseName'" :title="'Name'" :show="true">
    ...
    <div class="mb-3">
        ...
        <x-text-input id="last_name" name="last_name" type="text" class="form-control" :value="old('last_name', $user->last_name)" required autocomplete="last_name"/>
        <x-input-error class="mt-2" :messages="$errors->get('last_name')"/>
    </div>

    {{-- Designation --}}
    <div class="mb-3">
        <x-input-label for="designation" class="form-label" :value="__('Designation')"/>
        <x-text-input id="designation" name="designation" type="text" class="form-control" :value="old('designation', $user->designation)" autocomplete="designation"/>
