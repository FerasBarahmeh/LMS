...
<head>
    ...
    <!-- FAVICONS ICON ============================================= -->
    <link rel="icon" href="{{ asset('guest/assets/images/favicon.ico') }}" type="image/x-icon" />
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('guest/assets/images/favicon.png') }}" />
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset('guest/guest/assets/js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('guest/assets/js/respond.min.js') }}"></script>
    <![endif]-->

    <!-- All PLUGINS CSS ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/css/assets.css') }}">

    <!-- TYPOGRAPHY ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/css/typography.css') }}">

    <!-- SHORTCODES ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/css/shortcodes/shortcodes.css') }}">

    <!-- STYLESHEETS ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/css/style.css') }}">
    <link class="skin" rel="stylesheet" type="text/css" href="{{ asset('guest/assets/css/color/color-1.css') }}">

    <!-- REVOLUTION SLIDER CSS ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/vendors/revolution/css/layers.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/vendors/revolution/css/settings.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('guest/assets/vendors/revolution/css/navigation.css') }}">
...
<script src="{{ asset('guest/assets/vendors/bootstrap/js/popper.min.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/bootstrap-select/bootstrap-select.min.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/bootstrap-touchspin/jquery.bootstrap-touchspin.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/magnific-popup/magnific-popup.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/counter/waypoints-min.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/counter/counterup.min.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/imagesloaded/imagesloaded.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/masonry/masonry.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/masonry/filter.js') }}"></script>
<script src="{{ asset('guest/assets/vendors/owl-carousel/owl.carousel.js') }}"></script>
<script src="{{ asset('guest/assets/js/functions.js') }}"></script>
<script src="{{ asset('guest/assets/js/contact.js') }}"></script>
<script src='{{ asset('guest/assets/vendors/switcher/switcher.js') }}'></script>
