        ...
        <div class="tab-menu-heading">
            <div class="tabs-menu ">
                <ul class="nav panel-tabs">
                    ...
                    <!-- Landing page -->
                    <li class="">
                        <a href="{{ route('instructor.courses.manage.edit', $course->id) }}"
                            @class(['text-white', 'bg-dark','d-flex','justify-content-between','align-items-center','flex-row-reverse','op-6' => ! Route::is('instructor.courses.manage.edit'), 'active' => Route::is('instructor.courses.manage.edit')])>
