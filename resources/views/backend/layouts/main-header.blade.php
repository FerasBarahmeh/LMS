        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt="" src="{{ user()->service()->profilePicture() }}" class="profile-picture-uploaded"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ user()->service()->profilePicture() }}" class="profile-picture-uploaded"></div>
